...
const expectations = [
  ...
  ["scripts/lib/state.mjs:87-108", ["resolveWorkspaceHash", "ensureStateDir"]],
  ["scripts/lib/state.mjs:177-268", ["setCurrentSession", "getCurrentSession", "clearCurrentSession", "markSessionCleanupPending", "listPendingSessionCleanups", "clearSessionCleanupPending"]],
  ["scripts/lib/state.mjs:300-350", ["writeJobFile", "normalizeStoredJob"]],
  ["scripts/lib/state.mjs:427-813", ["mostRecentJobTimestamp", "isWithinReapGracePeriod", "reapStaleJobs"]],
  ["scripts/lib/state.mjs:862-1035", ["unlinkLockIfUnchanged", "remainingLockDeadlineMs", "lockProcessTimeout", "recoverStaleLock", "acquireJobLock", "releaseJobLock"]],
  ["scripts/lib/state.mjs:1101-1166", ["casJobStatus", "transitionJob", "writeAtomic", "withStateFileLock"]],
  ["scripts/lib/state.mjs:1172-1218", ["cleanupOldJobs"]],
