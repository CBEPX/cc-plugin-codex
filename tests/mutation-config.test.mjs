...
const expectations = [
  ...
  ["scripts/lib/state.mjs:420-470", ["writeJobFile", "normalizeStoredJob"]],
  ["scripts/lib/state.mjs:547-930", ["mostRecentJobTimestamp", "isWithinReapGracePeriod", "reapStaleJobs"]],
  ["scripts/lib/state.mjs:979-1151", ["unlinkLockIfUnchanged", "remainingLockDeadlineMs", "lockProcessTimeout", "recoverStaleLock", "acquireJobLock", "releaseJobLock"]],
  ["scripts/lib/state.mjs:1217-1282", ["casJobStatus", "transitionJob", "writeAtomic", "withStateFileLock"]],
  ["scripts/lib/state.mjs:1288-1334", ["cleanupOldJobs"]],
