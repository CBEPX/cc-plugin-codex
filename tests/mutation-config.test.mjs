...
const expectations = [
  ...
  ["scripts/lib/state.mjs:547-894", ["mostRecentJobTimestamp", "isWithinReapGracePeriod", "reapStaleJobs"]],
  ["scripts/lib/state.mjs:943-1115", ["unlinkLockIfUnchanged", "remainingLockDeadlineMs", "lockProcessTimeout", "recoverStaleLock", "acquireJobLock", "releaseJobLock"]],
  ["scripts/lib/state.mjs:1181-1246", ["casJobStatus", "transitionJob", "writeAtomic", "withStateFileLock"]],
  ["scripts/lib/state.mjs:1252-1298", ["cleanupOldJobs"]],
