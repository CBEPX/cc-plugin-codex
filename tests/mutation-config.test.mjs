...
const expectations = [
  ...
  ["scripts/lib/state.mjs:545-886", ["mostRecentJobTimestamp", "isWithinReapGracePeriod", "reapStaleJobs"]],
  ["scripts/lib/state.mjs:935-1107", ["unlinkLockIfUnchanged", "remainingLockDeadlineMs", "lockProcessTimeout", "recoverStaleLock", "acquireJobLock", "releaseJobLock"]],
  ["scripts/lib/state.mjs:1173-1235", ["casJobStatus", "transitionJob", "writeAtomic", "withStateFileLock"]],
  ["scripts/lib/state.mjs:1241-1287", ["cleanupOldJobs"]],
  ["scripts/lib/tracked-jobs.mjs:30-43", ["transitionTrackedJob"]],
  ["scripts/lib/tracked-jobs.mjs:273-357", ["createJobRecord", "createJobProgressUpdater"]],
  ["scripts/lib/tracked-jobs.mjs:376-530", ["runTrackedJob"]],
  ["scripts/lib/job-control.mjs:175-338", ["matchJobReference", "buildStatusSnapshot", "resolveCancelableJob"]],
