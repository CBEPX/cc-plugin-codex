...
function resolveManualCleanupPid(job) {
  return job.pgid ?? job.pid;
}

function formatManualCleanupCommand(pid, platform = process.platform) {
...
export function renderCancelReport(job, platform = process.platform) {
