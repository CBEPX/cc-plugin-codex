...
const shards = {
  ...
  state: {
    ...
    mutate: [
      ...
      "scripts/lib/state.mjs:420-470",
      "scripts/lib/state.mjs:547-894",
      "scripts/lib/state.mjs:943-1115",
      "scripts/lib/state.mjs:1181-1246",
      "scripts/lib/state.mjs:1252-1298",
    ],
  },
  "tracked-jobs": {
    command: "npm run test:mutation:state:unit",
