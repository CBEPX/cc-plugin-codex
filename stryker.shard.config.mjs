...
const shards = {
  ...
  state: {
    ...
    mutate: [
      ...
      "scripts/lib/state.mjs:528-821",
      "scripts/lib/state.mjs:870-1042",
      "scripts/lib/state.mjs:1108-1165",
      "scripts/lib/state.mjs:1171-1217",
      "scripts/lib/tracked-jobs.mjs:26-39",
      "scripts/lib/tracked-jobs.mjs:284-342",
      "scripts/lib/tracked-jobs.mjs:361-518",
    ],
  },
  "job-control": {
